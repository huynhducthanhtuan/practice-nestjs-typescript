...
export class RouteController {
  ...
  @ApiOperation({ summary: 'Generate New Itinerary' })
  @Post('/:id/generate')
  ...
  @ApiOperation({ summary: 'Get Itineraries By Account Id' })
  @Get('')
  @UseGuards(OptionalAuthGuard)
  @UsePipes(new ValidationPipe({ skipMissingProperties: true, transformOptions: { enableImplicitConversion: true } }))
  ...
  async getItinerary(@Param('itineraryId') itineraryId: string) {
  ...
  @ApiOperation({ summary: 'Get Recommended Itineraries Home Page' })
  @Get('/recommended')
