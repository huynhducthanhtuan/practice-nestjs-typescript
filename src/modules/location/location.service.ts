...
export class LocationService {
  ...
  async checkExistedLocationById(locationId: string) {
    const location = await this.locationRepo.findById(locationId);
    return Boolean(location);
  }

  async removeLocationById(locationId: string) {
  ...
  async updatedLocation(locationId: string, changedInfo: LocationUpdateDto) {
